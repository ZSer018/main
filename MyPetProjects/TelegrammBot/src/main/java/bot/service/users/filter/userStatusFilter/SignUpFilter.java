...
import bot.service.users.signup.CallbackPleaseConfirmData;
...
public class SignUpFilter extends ResponseService {
    ...
    public List<PartialBotApiMethod<? extends Serializable>> responseAction(Update update) {
        ...
        return List.of(new SimpleSendMessage("В процессе регистрации данная команда недоступна. Закончите пожалуйста резистрацию, или откажитесь от нее.").getNewMessage(update));
